...
export const CalligraphyHub: React.FC<CalligraphyHubProps> = ({ selectedJlpt, onGainXp }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 space-y-6">
      {/* Header */}
      <div className="bg-white dark:bg-stone-900 rounded-3xl p-6 sm:p-8 border border-stone-200 dark:border-stone-700/50 shadow-sm relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl">
          ...
          <h1 className="text-3xl sm:text-4xl font-black text-stone-900 dark:text-stone-100 mb-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 bg-white dark:bg-stone-900 rounded-3xl p-6 border border-stone-200 dark:border-stone-700/50 shadow-sm flex flex-col h-[600px]">
          {/* Tabs */}
          <div className="flex bg-stone-100 dark:bg-stone-800 p-1 rounded-2xl mb-4 shrink-0">
            {[
          ...
          <div className="relative mb-4 shrink-0">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 text-sm bg-stone-50 dark:bg-stone-800/50 border border-stone-200 dark:border-stone-700/50 rounded-xl focus:outline-none focus:ring-2 focus:ring-rose-500 focus:bg-white dark:bg-stone-900 transition"
            />
          </div>

          {category === 'kanji' && (
            <div className="flex gap-1 mb-4 bg-stone-100 dark:bg-stone-800 p-1 rounded-xl shrink-0">
              {(['N5', 'N4', 'N3', 'N2', 'N1'] as JLPTLevel[]).map(lvl => (
                <button
                  ...
                  className={`flex-1 py-1 text-xs font-bold rounded-lg transition-colors cursor-pointer ${
                    localJlpt === lvl ? 'bg-white dark:bg-stone-900 shadow-sm text-rose-600' : 'text-stone-500 hover:text-stone-800 dark:text-stone-200'
                  }`}
                >
                  {lvl}
                </button>
                ...
                <button
                  ...
                  className={`aspect-square flex items-center justify-center text-xl sm:text-2xl font-serif rounded-xl transition-all cursor-pointer ${
                    selectedChar === char
                      ...
                      : 'bg-stone-50 dark:bg-stone-800/50 text-stone-700 dark:text-stone-300 hover:bg-stone-100 dark:bg-stone-800 border border-stone-200 dark:border-stone-700/50'
                  }`}
                >
                  {char}
                </button>
        ...
        {/* Right Column: Canvas */}
        <div className="lg:col-span-2 flex flex-col items-center justify-center bg-white dark:bg-stone-900 rounded-3xl p-6 border border-stone-200 dark:border-stone-700/50 shadow-sm min-h-[500px]">
          {selectedChar ? (
