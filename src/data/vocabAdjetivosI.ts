...
export const VOCAB_ADJ_I: VocabItem[] = [
  {
    id: 'v_adj_i_n5_1',
    word: '危ない',
    reading: 'あぶない',
  ...
  },
  {
    ...
    reading: 'あたたかい',
    romaji: 'atatakai',
    meaningPt: 'Quente (clima, objetos)',
    category: 'adjetivo_i',
    jlpt: 'N5',
    categoryLabelPt: 'Adjetivo I',
    exampleSentence: {
  ...
  },
  {
    ...
    reading: 'うるさい',
    romaji: 'urusai',
    meaningPt: 'Barulhento, irritante',
    category: 'adjetivo_i',
    jlpt: 'N5',
    categoryLabelPt: 'Adjetivo I',
    exampleSentence: {
